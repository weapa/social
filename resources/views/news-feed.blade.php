...
{{--                        <-- $posts คือ ตัวที่มีค่ามากกว่า 1 ค่า หรืออาจจะมากมาก 1 ค่า อาจจะเป็น array หรืออาจจะเป็นตัว -->--}}
{{--                    <-- $post คือ ตัวแปรที่ทำหน้าที่วิ่งส่ง วิ่งใช้ครั้งละ 1 ค่า จาก $posts วงไปเรื่อยๆ ตามจำนวนที่มีอยู่ใน $posts ดังนั้นถ้าไม่มี s--}}
{{--                        คือ ตัวแปรที่ใช้วิ่งวน คล้ายกับตัวแปร i ใน for ของภาษาซี เช่น for(i=0; i++ <=$posts) {cout << i;}--}}
{{--                        7 ต้องการให้เหลือ 6-1--}}
{{--                        8 ต้องการให้เหลือ 7-1--}}
{{--                        9 ต้องการให้เหลือ 8-1--}}
{{--                        n ต้องการให้เหลือ n-1--}}

{{--                        dynamic Programming คือ มีการเครื่อนไหว เปลี่ยนแปลงตามเงื่อนไขต่างๆ--}}
